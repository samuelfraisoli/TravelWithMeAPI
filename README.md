...
```
java -Dspring.profiles.active=production -jar ./target/TravelWithMeAPI-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=tfg/travel-with-me-a-p-i
```
